...
\titleformat{\subsection}{\normalsize\bfseries}{\-\hspace{0.5cm}\thesubsection}{1ex}{}
...
\begin{table}[h!]
	...
	\hline
   version & to 1 & 1& 1 to 2 & 2 & 2 to 3& 3 & 3 to 4 & 4 & 4 to end\\[1ex]
   \hline
   drain & 9295 & 43(9338) & 8389 + 2(17729) & 8 (17737) & 30689 + 2(48428) & 285(48713) & 2233 + 2(resuming to nextPC) & 684 (51632) & 24029922\\[1ex]
   \hline
   only second & - & - & - & - & 48284(all ticks)& 285(48569) & 2235 (50804)& 684(51488) & 24030784\\[1ex]
   \hline
   no drain & 9295 & - & 8434 & - & 30555 & - & 2454 & - & 24031964\\[1ex]
   \hline
 \end{tabular}}
...
\textbf{Using 10000 repeat loop3:}\\
...
\section{Things TODO Now: Feb 18}

\begin{enumerate}
	\item modify the program or the cache size so that a high locality one won't even fit in l2 cache. make the array size to be 128 * 4 * 4 KB = 2 MB \textgreater 1MB (l2 cache size)
	
	\item run profiling for it
	
	\item add caches to the PIM port and make them 4 times smaller than the main cpu cache
	
	\item simulate PIM, normal system, only low locality PIM and pure PIM
	
	\item the cache line size used before is actually 64 bytes. The l2 cache used before actually have size of 256 KB. Therefore I don't have to change the program and run a new profiling. Therefore let's change the array size back to 65536 elements and run profiling again just for safety.
